...
#define TIMER4_OCO_CH                   (TIMER4_OCO_UH)    /* only TIMER4_OCO_UH  TIMER4_OCO_VH  TIMER4_OCO_WH */
...
int32_t main(void)
{
    ...
    if (!(TIMER4_OCO_CH%2ul))
    {
        ...
        TIMER4_OCO_SetHighChCompareMode(TIMER4_OCO_CH, &stcHighChCmpMode);  /* Set OCO high channel compare mode */
    }
