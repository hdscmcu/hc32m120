...
static uint32_t u32ExpectDstBufData[22] = {1, 2, 5, 6, 9, 10, 13, 14, 17, 18, 21,
...
int32_t main(void)
{
    ...
    /* set source address non_sequnce & offset */
    DMA_NonSeqInit(DMA_CH, DMA_RPTNSSEL_SRCNSEQ, DMA_OFFSET , DMA_NSEQCNT);
