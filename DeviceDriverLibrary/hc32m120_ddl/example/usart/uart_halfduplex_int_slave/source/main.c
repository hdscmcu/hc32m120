...
static void UartSlaveUnitTxIrqCallback(void)
{
    ...
    en_functional_state_t enState = USART_GetFuncState(UART_SLAVE_UNIT, USART_INT_TXE);
...
static void UartSlaveUnitTcIrqCallback(void)
{
    ...
    en_functional_state_t enState = USART_GetFuncState(UART_SLAVE_UNIT, USART_INT_TC);
...
static void UartSlaveUnitRxIrqCallback(void)
{
    ...
    en_functional_state_t enState = USART_GetFuncState(UART_SLAVE_UNIT, USART_INT_RX);
...
int32_t main(void)
{
    ...
    GPIO_SetFunc(UART_SLAVE_TX_PORT, UART_SLAVE_TX_PIN, UART_SLAVE_TX_GPIO_FUNC);
